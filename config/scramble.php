...
return [
    ...
    'info' => [
         ...
         */
        'description' => "Multi-currency payment request API for the Buzzvel 2026 Dev Team Test.\n\n"
            .'Register or log in via the endpoints below to obtain a Sanctum token, then click '
            .'**Authorize** and paste it as `Bearer <token>` to try out the protected endpoints '
            ."(payment requests, approvals, etc.) directly from this page.\n\n"
            .'Seeded demo accounts (password `password`): `maria.costa@buzzvel.com` (employee, BRL) '
            .'and `anna.mueller@buzzvel.com` (finance).',
    ],

    'ui' => [
        'title' => 'Buzzvel Payments API',
    ],
